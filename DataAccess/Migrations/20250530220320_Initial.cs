        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminProjectId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PreviousTasksId = table.Column<int>(type: "int", nullable: false),
                    SameTimeTasksId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskTask", x => new { x.PreviousTasksId, x.SameTimeTasksId });
                    table.ForeignKey(
                        name: "FK_TaskTask_Tasks_PreviousTasksId",
                        column: x => x.PreviousTasksId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskTask_Tasks_SameTimeTasksId",
                        column: x => x.SameTimeTasksId,
                        principalTable: "Tasks",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskTask_SameTimeTasksId",
                table: "TaskTask",
                column: "SameTimeTasksId");

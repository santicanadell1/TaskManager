...
namespace Service.Test.ModelsTests
{
    ...
    public class TaskDTOTest
    {
        ...
        public void NewTask_WhenPreviousTasksAreAssigned_ThenPreviousTasksAreSet()
        {
            ...
            TaskDTO taskDTO = new TaskDTO { PreviousTasks = previousTasks };
        ...
        public void NewTask_WhenSameTimeTasksAreAssigned_ThenSameTimeTasksAreSet()
        {
            ...
            TaskDTO taskDTO = new TaskDTO { SameTimeTasks = sameTimeTasks };
        ...
        {
            StateDTO stateTodo = StateDTO.TODO;
            StateDTO stateDoing = StateDTO.DOING;
            StateDTO stateDone = StateDTO.DONE;

            TaskDTO taskTodo = new TaskDTO { State = stateTodo };
            TaskDTO taskDoing = new TaskDTO { State = stateDoing };
            TaskDTO taskDone = new TaskDTO { State = stateDone };
        ...
        {
            int? idValue = 123;
            TaskDTO taskDTO = new TaskDTO { Id = idValue };
        ...
        public void NewTask_WhenResourcesAreAssigned_ThenResourcesAreSet()
        {
            ...
            TaskDTO taskDTO = new TaskDTO { Resources = resources };

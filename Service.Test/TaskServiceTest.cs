...
namespace Service.Test
{
    ...
    public class TaskServiceTest
    {
        ...
        {
            TaskDTO taskDTO1 = _taskService.GetTask("Generic Project",
                _repositoryManager.TaskRepository.Get(t => t.Title == "Task 1").Title);
            TaskDTO taskDTO2 = _taskService.GetTask("Generic Project",
        ...
        {
            Task Task1 = _repositoryManager.TaskRepository.Get(t => t.Title == "Task 1");
            ResourceDTO newResourceDTO = new ResourceDTO { Name = "Updated Resource", Type = "Updated Type", Description = "Updated Desc" };
        ...
        public void GetTask_ShouldCorrectlyMapTaskProperties_TestingFromEntity()
        {
            ...
            Project project = _repositoryManager.ProjectRepository.Get(p => p.Name == "Generic Project");
            Task addedTask = project.Tasks.FirstOrDefault(t => t.Title == "Mapping Test Task");
            Assert.IsNotNull(addedTask, "La tarea no se agregó correctamente al proyecto");

            TaskDTO taskDTO = _taskService.GetTask("Generic Project", addedTask.Title);
        ...
        {
            Task taskA = new Task("Task A", "Description A", DateTime.Now, 1, new List<Task>(), new List<Task>(), new List<Resource>());
            Task taskB = new Task("Task B", "Description B", DateTime.Now, 2, new List<Task>(), new List<Task>(), new List<Resource>());
            Task taskC = new Task("Task C", "Description C", DateTime.Now, 3, new List<Task>(), new List<Task>(), new List<Resource>());
            ...
            _repositoryManager.ResourceRepository.Add(new Resource { Name = "Complex Update Resource", Type = "Update Type", Description = "Update Resource Description" });
            _context.SaveChanges();
            Resource resourceEntity = _repositoryManager.ResourceRepository.Get(r => r.Name == "Complex Update Resource");
        ...
        public void AddTask_ShouldRescheduleTask_WhenResourceInUseAndSolveTrue()
        {
            ...
            TaskDTO toSchedule = new TaskDTO
            {
                Title = "ResolvedTask",
            ...
            TaskDTO scheduled = _taskService.GetTask("Generic Project", "ResolvedTask");
        ...
        {
            TaskDTO conflictingTask = new TaskDTO
            {
                Title = "ConflictTask",
        ...
        {
            ResourceDTO resourceInUse = _resourceDTO1;
            DateTime originalStart = _taskDTO1.ExpectedStartDate.Date;
            ...
            TaskDTO updated = _taskService.GetTask("Generic Project", "Task 2 Rescheduled");
        ...
        public void GetExistingTasksFromIds_ShouldHandleTasksWithoutIds()
        {
            ...
            {
                new TaskDTO { Id = null, Title = "Task Without ID", Description = "This task has no ID" }
            };
        ...
        public void GetExistingTasksFromIds_ShouldHandleNonExistentIds()
        {
            ...
            {
                new TaskDTO { Id = 999999, Title = "Task With Invalid ID", Description = "This task has an ID that doesn't exist" }
            };
